...
* Tests
  ...
  If you look at **/test** folder you will se that this template came ready configured to test. It uses the awesome [karma-runner.github.com](karma runner)( testacularjs++ ) as test runner. Configurations are defined in karma*.conf.js files.
